...
float                     MultiDimFit::L_ = 0;
float                     MultiDimFit::L0_ = 0;
...
void MultiDimFit::initOnce(RooWorkspace *w, RooStats::ModelConfig *mc_s) {
    ...
    Combine::addBranch("LL", &L_, "LL/F");
    Combine::addBranch("L0", &L0_, "L0/F");
}
            ...
            for (unsigned int j = 0; j < sqrn; ++j, ++ipoint) {
                ...
                *params = snap; 
                ...
                if (nll.numEvalErrors() > 0) { 
                    ...
                    L_ = 9999; Combine::commitPoint(true, /*quantile=*/0); 
                    L0_ = 9999; Combine::commitPoint(true, /*quantile=*/0); 
                    if (gridType_ == G3x3) {
